$(document).ready(function () {
  ...
  $(".outer").mouseenter(function(){
    ...
    if($(this).hasClass('activeState')) {
      ...
      $(this).addClass("activeState");
          ...
          setTimeout(function() {
            $('.one .stickyArrow').addClass('animated shake-horizontal')
          ...
          setTimeout(function() {
            $('#clicked4 .box').removeClass('transparent').addClass('animated tada')
              ...
              setTimeout(function() {
                $('.two .stickyArrow').addClass('animated shake-horizontal')
        ...
        if($('.three').hasClass('activeState')) {
            ...
            setTimeout(function() {
              $('.three .stickyArrow').addClass('animated shake-horizontal')
  ...
  if($('.four').hasClass('activeState')) {
                ...
                setTimeout(function() {
                  $('.four .stickyArrow').addClass('animated shake-horizontal')
...
//
//         setTimeout(function() {
//             $('.one .stickyArrow').removeClass('animated shake-horizontal')
//
//           },400)
//
//           setTimeout(function() {
...
// })
  ...
  //
  //               setTimeout(function() {
  //             $('.two .stickyArrow').removeClass('animated shake-horizontal')
  //
  //           },400)
  //
  //
  //     $('.two').removeClass('newPage')
  //
  //     // if($('.two').hasClass('activeState') && !$('.three').hasClass('activeState') && !$('.four').hasClass('activeState') && !$('.one').hasClass('activeState')) {
  //
  ...
  //
  //
  //     $('.three').removeClass('newPage')
  //
  //     setTimeout(function() {
  //   $('.three .stickyArrow').removeClass('animated shake-horizontal')
  //
  // },400)
  //
  //     //
  ...
  //   $(this).one('mouseleave', function() {
  //
  //     $('.four').removeClass('newPage')
  //     // if($('.four').hasClass('activeState') && !$('.three').hasClass('activeState') && !$('.two').hasClass('activeState') && !$('.one').hasClass('activeState')) {
  //
  //
  //     setTimeout(function() {
  //   $('.four .stickyArrow').removeClass('animated shake-horizontal')
  //
  // },400)
  //
  //
